...
| Fuel-shell saturation (propulsion bounded) | ❌ **FAILS for the QUADRATIC action (2026-06-05 long-horizon)**: the 900-step plateau was transient — a negative-H fuel runaway opens at τ ≈ 2 clock periods, dt-invariant, in f64≡f32, V-on/off, 24³/63³ ⇒ compactness + backreaction do NOT saturate; the field-level twin of the 2b-1 no-cap theorem and the 1D article's own βR⁴ requirement | **G-2c-2 reframed**: bounded H under the action + a saturating higher-order invariant — **M5.8.2d** (quartic-term sandbox) + the Duda question (which 4D invariant is canonical) |
