...
```text
0 IMMEDIATE   Nothing blocks M5.4. The substrate decision is locked and
              the migration is mechanical (storage + operators + eigen
              kernel + reproduce Coulomb). No external input is awaited
              to start it.
...
Total: 12 questions (0 immediate, 7 open, 5 resolved). M5.4 unblocked.
```
