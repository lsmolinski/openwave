...
| Fuel-shell saturation (propulsion bounded) | 🔶 first positive (2c-1 + B-1): H rose then PLATEAUED (9.8→17.4→17.1 over 900 steps, v-cap never engaged — no trace of the λ≈15.6/t catastrophe) — but the explicit scheme pumps ~2× before the plateau, so scheme-pumping vs physics isn't separated yet | **G-2c-2**: bounded H + amplitudes in the full nonlinear compact-orbit evolution, conservation-grade stepper |
