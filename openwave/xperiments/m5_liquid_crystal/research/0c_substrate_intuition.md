...
> | **Why `1/r³` for B but `1/r²` for E?** A dipole's two effective poles nearly cancel ⇒ one power of `r` faster falloff than a monopole. (Quadrupole would be `1/r⁴`, etc.) | Our placeholder `B(r)=amp·[3(m̂·r̂)r̂−m̂]/r³` has the `1/r³` baked in — verified in the smoke-test. |
