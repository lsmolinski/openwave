...
>
> 🚧 **Sub-step plan:** ✅ M5.6.1 KG-from-twist sandbox (DONE — mass is geometric, regularization sets the scale; `5a §5a`) → 🚧 **M5.6.2 disclination + core handling (NEXT)** → M5.6.3 Faber V-on regularization → M5.6.4 Maxwell sector → M5.6.5 Taichi port + biaxial-ellipsoid rendering.
