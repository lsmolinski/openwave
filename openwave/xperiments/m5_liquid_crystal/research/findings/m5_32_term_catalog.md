...
| `K_P^23` | K_P^23 (R15, on the degenerate vacuum): E = (1/2)[sum_i tr(Om_i^T eta Om_i eta) + omega^2 tr(Om_0^T eta Om_0 eta)], Om_mu = P23 A_mu eta P23, P23 = I - P_g - P_1 the exact Lagrange projector onto the (lambda_2, lambda_3) eigenplane of N = M eta (equal to the author's (N - g)(N - 1)/[(l23 - g)(l23 - 1)] at l2 = l3); tr(Om^T H Om H^-1) = tr(Om^T eta Om eta) on the projected block (P23 u = 0); not an LP entrant (R15 ran on the degenerate vacuum, off the frozen rows) |
| `SPLIT` | mu (lambda_2 - lambda_3)^2 = mu (s^2 - 4 p), s = tr N - lambda_g - lambda_1, p = det N / (lambda_g lambda_1): the author's split stiffness at the degenerate point (class C3, the invariant reading; the diagonal-entry reading differs off the diagonal sector, P-iii audit); the Hessian stiffness 4 mu per unit split direction; not an LP entrant |
