...
modulation lever, one code path. Calibration `δθ_peak = π·(A/λ)` (A/λ=1 ⇒ π antipodal =
...
oscillation (continuous EM forcing, the driven-excess lever) is a *separate* question this free-dispersal null
...
that washed out). ⇒ the free particle/clock is 4D (M5.8) but the **driven-excess** state is a real 3D lever
