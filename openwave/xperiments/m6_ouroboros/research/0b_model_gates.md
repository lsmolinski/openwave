...
Last updated: 2026-05-21 morning (post v7 Phase 1 — **mode-selector wall: 7 anchor variants tested, none reach Paul's prescribed ground state**; email v7 sent with Q31/Q32/Q33; v6.6 H_electron/Q=1.7112 (0.84% off, 5-node first-excited) remains best result; M5 path in foreground per cardinal rule).
