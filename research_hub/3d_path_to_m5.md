...
**Next action**: **M5.2** — wave dynamics from Close's Eq. 23 + Klein-Gordon mass term. M5.1 complete; M5.2 unblocked. First M5.2 success criterion: defect survives EVOLVE PSI under V(ψ) (currently dissolves under free-wave V=0 per Derrick collapse).
