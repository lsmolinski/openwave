...
- 🔶 M5 / LAGRANGIAN-FIELD METHOD implementation (dir `openwave/xperiments/m5_lagrangian_field/`) — see [3d_path_to_m5.md](3d_path_to_m5.md) for full sub-phase plan
  ...
  - 🚧 M5.1 Port topology from Exps 2, 3 — `seed_vacuum`, `seed_hedgehog`, Frank energy, gradient-descent relaxation, **director-glyph visualizer** (3-plane line glyphs with signed-component RGB; design in `research_hub/3e_director_glyph_rendering.md`), 1/d Coulomb gating test, winding-number tracker
